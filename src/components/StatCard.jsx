...
const topProducts = [
  { name: 'Kamus Inggris-Indonesia', sold: 245, revenue: 12250000 },
  { name: 'Riyadhus Shalihin', sold: 180, revenue: 9000000 },
  { name: 'Mukjizat Al-Quran', sold: 150, revenue: 7500000 },
  { name: 'Buku Tulis Sinar Dunia', sold: 320, revenue: 6400000 },
  { name: 'Al-Quran Tajwid', sold: 95, revenue: 4750000 },
];
...
export default function DashboardPage() {
  ...
  const recentActivities = [
    { id: 1, customer: 'Budi Santoso', type: 'Order', amount: 170000, status: 'pending', time: '2 jam lalu' },
    { id: 2, customer: 'Siti Rahayu', type: 'Order', amount: 150000, status: 'pending', time: '3 jam lalu' },
    { id: 3, customer: 'Ahmad Fauzi', type: 'Order', amount: 300000, status: 'pending', time: '4 jam lalu' },
    { id: 4, customer: 'Dewi Kartika', type: 'Order', amount: 145000, status: 'pending', time: '5 jam lalu' },
    { id: 5, customer: 'Rizky Pratama', type: 'Order', amount: 340000, status: 'pending', time: '6 jam lalu' },
  ];
  ...
  return (
    <Container className="pb-8 relative">
      {/* PAGE HEADER */}
      <PageHeader 
        title="Dashboard" 
      ...
      >
        <div className="flex items-center gap-3">
          <button 
            ...
            className="p-2 bg-white rounded-xl border border-[#D7DBEC] hover:bg-gray-50 transition shadow-sm"
          >
            {showBalance ? <FaEye className="text-[#1E5EFF]" /> : <FaEyeSlash className="text-gray-400" />}
          </button>
        </div>
      </PageHeader>

      {/* ============================================================ */}
      {/* STAT CARDS - LANGSUNG DI KODINGAN */}
      {/* ============================================================ */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 border border-[#D7DBEC] hover:shadow-md transition">
          ...
          <p className="text-2xl font-bold text-[#131523]">
            {showBalance ? 'Rp 4.150.000' : '••••••'}
          </p>
        ...
        {/* Card 4: Total Buku Terjual */}
        <div className="bg-white rounded-2xl shadow-sm p-5 border border-[#D7DBEC] hover:shadow-md transition">
          <div className="flex justify-between items-start mb-2">
            <p className="text-sm font-medium text-[#7E84A3]">Buku Terjual</p>
            <span className="text-xl">📚</span>
          </div>
          <p className="text-2xl font-bold text-[#131523]">245</p>
          <div className="flex items-center gap-1 mt-2">
      ...
      {/* ============================================================ */}
      {/* CHART 2: BAR CHART - PENJUALAN TERLARIS */}
      {/* ============================================================ */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="md:col-span-2 bg-white rounded-2xl shadow-sm p-6 border border-[#D7DBEC] hover:shadow-md transition">
          <div className="flex justify-between items-start mb-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <SectionTitle title="🏆 Penjualan Terlaris" className="border-0 p-0 m-0" />
                <Badge type="warning" size="xs" className="ml-2">Bar Chart</Badge>
              </div>
              <p className="text-xs text-[#A1A7C4]">Membandingkan produk terlaris berdasarkan jumlah terjual</p>
            </div>
          ...
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={topProducts} layout="vertical" margin={{ top: 5, right: 10, left: 80, bottom: 5 }}>
              ...
              <YAxis type="category" dataKey="name" tick={{ fontSize: 10, fill: '#5A607F' }} axisLine={false} tickLine={false} width={90} />
              <Tooltip 
                contentStyle={{ 
                  borderRadius: '12px', 
                  border: '1px solid #E5E7EB',
          ...
          <div className="flex justify-between mt-3 text-xs text-[#A1A7C4] border-t border-[#F0F1F5] pt-3">
            <span>💡 <span className="font-medium text-[#5A607F]">Bar Chart</span> = Bandingkan produk terlaris</span>
            <span>🏆 Terbanyak: <span className="text-[#1E5EFF] font-bold">Buku Tulis</span> (320 pcs)</span>
          </div>
        </div>
      ...
      {/* ============================================================ */}
      {/* TOMBOL WHATSAPP - FLOATING DI BAWAH */}
      {/* ============================================================ */}
      <button 
